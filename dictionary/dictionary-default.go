...
// source: https://github.com/truthfulses/go-sastrawi/blob/master/dictionary-default.go

var defaultWords = []string{"aba", "abad", "abadi", "abadiah", "abah", "abai", "abaimana", "abaka",
